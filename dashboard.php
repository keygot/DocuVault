    ...
    <div class="pagetitle">
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Hệ thống quản lý thông tin</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Recent Sales <span>| Hôm nay</span></h5>
        ...
        <div class="col-lg-4">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">Recent Activity <span>| Hôm nay</span></h5>
          ...
          <div class="card">
            ...
            <div class="card-body pb-0">
              <h5 class="card-title">Báo cáo ngân sách <span>| Tháng nay</span></h5>
          ...
          <div class="card">
            ...
            <div class="card-body pb-0">
              <h5 class="card-title"> Số lượng truy cập <span>| Hôm nay</span></h5>
